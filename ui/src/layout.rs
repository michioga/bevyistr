...
use visualization::{
    ...
    ContactReviewSettings, DefinedContactPreview, DefinedMpcPreview, MpcPairDraftPreview,
...
fn next_mpc_pair_name(setup: &fem_core::AnalysisSetup) -> String {
    for serial in 1.. {
...
fn remove_mpc_equation_or_group(
...
mod sidebar_page_tests {
    ...
    use super::{
        ...
        create_contact_from_draft, merge_mesh_contact_pairs, next_mpc_pair_name,
        page_supports_part_position, page_supports_tool, pair_mpc_equations,
        remove_mpc_equation_or_group, selected_nodes_by_mesh, selection_context_for_page,
    ...
    use fem_core::{
        ...
        MeshLoadStatus, MpcEquation, NodeId, SelectionHit, SelectionLevel, ViewportTool,
    };
    use interaction::HoverResult;
    ...
    fn pair_mpc_xyz_builds_three_grouped_equal_displacement_equations() {
        let equations =
            pair_mpc_equations("MPC_PAIR_1", (0, NodeId(10)), (1, NodeId(20)), 0).unwrap();
    ...
    fn pair_mpc_single_dof_and_name_generation_are_collision_safe() {
        let equations =
            pair_mpc_equations("MPC_PAIR_2", (0, NodeId(1)), (0, NodeId(2)), 2).unwrap();
        assert_eq!(equations.len(), 1);
