...
fn element_type_label(element_type: &fem_core::ElementType) -> String {
    match element_type {
        fem_core::ElementType::Rod2    => "Rod2".to_string(),
        fem_core::ElementType::Tri3    => "Tri3".to_string(),
        fem_core::ElementType::Tri6    => "Tri6".to_string(),
        fem_core::ElementType::Quad4   => "Quad4".to_string(),
        fem_core::ElementType::Quad8   => "Quad8".to_string(),
        fem_core::ElementType::Tet4    => "Tet4".to_string(),
        fem_core::ElementType::Tet10   => "Tet10".to_string(),
        fem_core::ElementType::Prism6  => "Prism6".to_string(),
        fem_core::ElementType::Prism15 => "Prism15".to_string(),
        fem_core::ElementType::Hex8    => "Hex8".to_string(),
        fem_core::ElementType::Hex20   => "Hex20".to_string(),
        fem_core::ElementType::Beam611 => "Beam611".to_string(),
        fem_core::ElementType::Beam641 => "Beam641".to_string(),
