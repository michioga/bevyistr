...
use assembly::{
    ...
    spawn_assembly_viewport_visuals, update_assembly_gizmo_visuals, update_assembly_part_overlays,
};

use layout::{
    ActiveLoadEditor, CameraFitRequest, PlaybackState, SelectedDloadKind, SelectedEgrp,
    SelectedLoadDirection, SelectedMaterialForSection, SelectedSectionType, SelectionGuideState,
    SidebarPage, SurfaceSelectionSettings, UndoInProgress, UndoStack, accept_contact_button_system,
    ...
    assembly_transform_button_system, camera_refit_on_reload, clear_all_bc_loads_button_system,
    constraint_preset_button_system, contact_candidate_action_button_system,
    contact_ghost_toggle_button_system, create_contact_button_system, create_surface_button_system,
    defined_contact_button_system, delete_setup_entry_button_system, detect_contacts_button_system,
    dload_kind_button_system, egrp_select_button_system, export_button_system, handle_panel_wheel,
    ...
    surface_selection_mode_button_system, sync_defined_contact_preview, sync_load_measurement_box,
    ...
    update_contact_candidate_text, update_contact_review_controls, update_contact_review_settings,
    update_hover_preview_group, update_mesh_stats_text, update_result_stats_text,
    update_selection_context, update_selection_info_text, update_selection_operation_hint,
    update_selection_stats_text, update_sidebar_page_visibility, update_surface_selection_hint,
    ...
    fn build(&self, app: &mut App) {
        ...
        app.add_systems(
            ...
            (
                ...
                update_measurement_box_visuals.after(sync_load_measurement_box),
            )
